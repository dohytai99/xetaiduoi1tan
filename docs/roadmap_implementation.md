...
- [x] Embed tool tra cứu (file `tra_cuu_xe.html`)
- [x] Add animations (Prompt 8)
- [x] Mobile optimization (Prompt 9)

**Ngày 7: Content Integration**
- [x] Convert Markdown posts to HTML
- [x] Add images (tìm/mua stock photos)
- [x] Format tables và lists
...
- [x] Add Schema markup (Organization, Article, Product)
- [x] Generate XML sitemap
- [x] Configure robots.txt
- [x] Set canonical URLs
- [x] Optimize page speed (target 90+ PageSpeed score)
